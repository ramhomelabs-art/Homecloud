            ...
            <div className="modal-content glass" style={{ width: '420px', textAlign: 'left' }}>
                ...
                {step === 'search' && (
                    <form onSubmit={handleDiscover}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                            <p style={{ fontSize: '12px', color: 'var(--text-secondary)', margin: 0 }}>Enter an IP to find its shares, or leave blank to scan the network.</p>
                                ...
                                <div style={{ textAlign: 'center', padding: '20px', color: '#484f58', fontSize: '13px' }}>
                                    ...
                                    {rawOutput && (
                                        <div style={{ marginTop: '10px' }}>
                                            ...
                                            {showDebug && (
                                                <pre style={{ textAlign: 'left', background: 'var(--bg-surface-0)', padding: '10px', marginTop: '8px', fontSize: '10px', color: 'var(--text-secondary)', whiteSpace: 'pre-wrap', maxHeight: '100px', overflowY: 'auto', border: '1px solid var(--border-subtle)' }}>
                                                    {rawOutput}
                                                </pre>
                                            )}
                                        </div>
                ...
                {step === 'credentials' && (
                    <form onSubmit={handleFinalize}>
                        {manualMode ? (
                            <>
                                <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '24px' }}>Enter the exact folder path to mount.</p>
                            ...
                            <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '24px' }}>Connecting to <b>\\{ip}\{selectedShare}</b>. Enter credentials if required.</p>
                        )}
