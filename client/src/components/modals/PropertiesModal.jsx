...
const PropRow = ({ label, value }) => (
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <span style={{ fontSize: '13px', fontWeight: '500', color: '#e6edf3', maxWidth: '200px', textAlign: 'right', wordBreak: 'break-all' }}>{value}</span>
    </div>
);
            ...
            <div className="modal-content glass" style={{ textAlign: 'left', width: '380px', padding: '24px' }} onClick={e => e.stopPropagation()}>
                <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginBottom: '24px' }}>
                    ...
                    <div style={{ overflow: 'hidden' }}>
                        ...
                        <p style={{ margin: '4px 0 0', fontSize: '12px', color: '#8b949e', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{isDir ? 'System Folder' : 'Binary Fragment'}</p>
                    </div>
                </div>
