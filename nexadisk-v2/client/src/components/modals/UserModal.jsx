                ...
                <form onSubmit={handleSubmit}>
                    {!isReset && (
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>USERNAME</label>
                                <input
                                    name="username"
                                    type="text"
                                    defaultValue={user.username || ''}
                                    required
                                    style={{ width: '100%', padding: '10px', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--border-dim)', borderRadius: '8px', color: '#fff', outline: 'none' }}
                                />
                            </div>
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>ROLE</label>
                                <select
                                    name="role"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>ACCOUNT STATUS</label>
                                <select
                                    name="account_status"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>DISPLAY NAME</label>
                                <input
                                    name="display_name"
                                    type="text"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>FIRST NAME</label>
                                <input
                                    name="first_name"
                                    type="text"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>LAST NAME</label>
                                <input
                                    name="last_name"
                                    type="text"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>EMAIL</label>
                                <input
                                    name="email"
                                    type="email"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>PHONE</label>
                                <input
                                    name="phone"
                                    type="text"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>DEPARTMENT</label>
                                <input
                                    name="department"
                                    type="text"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>JOB TITLE</label>
                                <input
                                    name="job_title"
                                    type="text"
                            ...
                            <div style={{ gridColumn: '1 / -1' }}>
                                <label style={{ display: 'block', fontSize: '11px', color: '#8b949e', marginBottom: '6px', fontWeight: 'bold' }}>BIO</label>
                                <textarea
                                    name="bio"
                                    defaultValue={user.bio || ''}
                                    placeholder="Brief bio..."
                                    style={{ width: '100%', height: '80px', padding: '10px', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--border-dim)', borderRadius: '8px', color: '#fff', outline: 'none', resize: 'vertical' }}
                                />
                            </div>
                        </div>
                    )}
