...
const AvatarUploadDialog = ({ user, onClose, onSuccess }) => {
    ...
    const styles = {
        ...
        modal: { background: '#0d1117', border: '1px solid #30363d', borderRadius: '12px', padding: '24px', width: '100%', maxWidth: '500px', color: '#c9d1d9' },
        ...
        btnCancel: { background: 'transparent', border: '1px solid #30363d', color: '#c9d1d9', padding: '8px 16px', borderRadius: '6px', cursor: 'pointer' },
        btnSave: { background: '#238636', border: 'none', color: '#fff', padding: '8px 16px', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }
    };
            ...
            <div style={styles.modal}>
                ...
                {!imgSrc ? (
                    ...
                    >
                        ...
                        <div style={{ fontSize: '12px', color: '#8b949e', marginTop: '8px' }}>JPG, PNG or WEBP (Max 5MB)</div>
                    </div>
                ) : (
                    <div style={{ background: '#010409', padding: '16px', borderRadius: '8px', display: 'flex', justifyContent: 'center' }}>
                        <ReactCrop
                            crop={crop}
