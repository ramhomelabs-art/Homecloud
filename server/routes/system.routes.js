...
router.post('/test-alert', authenticateToken, (req, res) => {
    const { sendAlert } = require('../utils/notifier');
    sendAlert('user_login', {
        title: 'System Test Alert',
        text: 'This is a mock system alert generated by the NexaDisk Alert Management Console to verify bot connectivity.',
        htmlText: '🔔 <b>[System Test Alert]</b>\nThis is a mock system alert dispatched from the NexaDisk Alert Management Console to verify Telegram Bot connectivity.',
        type: 'info'
    })
